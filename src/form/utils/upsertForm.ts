...
>(
  ...
  if (isUpdate) {
    ...
    // deepMerge réutilise les références des inputs du form d'origine : il faut
    // les cloner avant de muter leur `value`, sinon l'état précédent est modifié
    // en place et React (Compiler) ne re-rend pas les contrôleurs concernés.
