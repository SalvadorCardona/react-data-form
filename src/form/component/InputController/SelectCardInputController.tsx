...
/**
 * Sélecteur sous forme de cartes pleine largeur empilées verticalement
 * (titre + description), identique au style utilisé dans le tunnel de
 * création de rendez-vous (`ServiceOptionSelectInputController`).
