...
/**
 * Bouton « Ajouter » qui ouvre une fenêtre de choix du bloc (formulaire) à
 * ajouter. C'est la palette du page builder : chaque formulaire enregistré via
 * `addForm` devient un type de bloc sélectionnable.
 */
